...
public sealed partial class ServerStationJobsSystem : StationJobsSystem
{
    ...
    /// <inheritdoc cref="TryAssignJob(Robust.Shared.GameObjects.EntityUid,string,NetUserId,Shared.Station.Components.StationJobsComponent?)"/>
    ...
    /// <inheritdoc cref="TryAdjustJobSlot(Robust.Shared.GameObjects.EntityUid,string,int,bool,bool,StationJobsComponent?)"/>
    ...
    /// <inheritdoc cref="TrySetJobSlot(Robust.Shared.GameObjects.EntityUid,string,int,bool,StationJobsComponent?)"/>
    /// <param name="station">Station to adjust the job slot on.</param>
