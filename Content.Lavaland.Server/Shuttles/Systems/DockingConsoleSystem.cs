...
public sealed partial class DockingConsoleSystem : SharedDockingConsoleSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<RefreshShuttleConsolesEvent>(OnRefreshConsoles);
    ...
    private void OnRefreshConsoles(ref RefreshShuttleConsolesEvent args)
    {
        UpdateConsolesUsing(args.Grid);
    }
    ...
    /// <summary>
    /// Update the UI of every docking console.
    /// </summary>
