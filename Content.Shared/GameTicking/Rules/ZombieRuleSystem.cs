...
public abstract partial class ZombieRuleSystem : GameRuleSystem<ZombieRuleComponent>
{
        ...
        ref RoundEndTextAppendEvent args)
    {
        ...
        var healthy = GetHealthyHumans(true); // Trauma - pass true
    ...
    /// <returns></returns>
    protected float GetInfectedFraction(bool includeOffStation = false, bool includeDead = true) // Trauma - swap both bools defaults
    {
    ...
    /// </summary>
    /// <returns></returns>
    protected List<EntityUid> GetHealthyHumans(bool includeOffStation = false) // Trauma - default to excluding them
    {
