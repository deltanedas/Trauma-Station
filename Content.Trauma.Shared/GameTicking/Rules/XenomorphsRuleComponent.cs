...
public sealed partial class XenomorphsRuleComponent : Component
{
    ...
    [DataField]
    public XenoWinType WinType = XenoWinType.Neutral;

    [DataField]
    public List<XenoWinCondition> WinConditions = new ();

    #endregion
}

public enum XenoWinType : byte
{
    XenoMajor,
    XenoMinor,
    Neutral,
...
public enum XenoWinCondition : byte
{
